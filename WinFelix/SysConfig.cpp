...
void SysConfig::serialize( std::filesystem::path path )
{
  ...
  fout << "debugOptions = {\n";
  fout << "\tvisualizeBreakCount = " << debugOptions.visualizeBreakCount << ";\n";
  fout << "\tvisualizeCPUCount = " << debugOptions.visualizeCPUCount << ";\n";
  fout << "\tvisualizeDisasmCount = " << debugOptions.visualizeDisasmCount << ";\n";
  fout << "\tvisualizeMemCount = " << debugOptions.visualizeMemCount << ";\n";
  fout << "\tvisualizeWatchCount = " << debugOptions.visualizeWatchCount << ";\n";
  fout << "\tdisasmOptions = {\n";
  fout << "\t\tFollowPC              = " << ( debugOptions.disasmOptions.followPC ? "true;\n" : "false;\n" );
  fout << "\t\tShowLabelsInAddrCol   = " << ( debugOptions.disasmOptions.ShowLabelsInAddrCol ? "true;\n" : "false;\n" );
  fout << "\t\ttablePC               = " << debugOptions.disasmOptions.tablePC << ";\n";
  fout << "};\n";
  fout << "};\n";
  fout << "memoryOptions = {\n";
...
SysConfig::SysConfig( sol::state const& lua )
{
  ...
  debugOptions.visualizeBreakCount = lua["debugOptions"]["visualizeBreakCount"].get_or( debugOptions.visualizeBreakCount );
  debugOptions.visualizeCPUCount = lua["debugOptions"]["visualizeCPUCount"].get_or( debugOptions.visualizeCPUCount );
  debugOptions.visualizeDisasmCount = lua["debugOptions"]["visualizeDisasmCount"].get_or( debugOptions.visualizeDisasmCount );
  debugOptions.visualizeMemCount = lua["debugOptions"]["visualizeMemCount"].get_or( debugOptions.visualizeMemCount );
  debugOptions.visualizeWatchCount = lua["debugOptions"]["visualizeWatchCount"].get_or( debugOptions.visualizeWatchCount );
  debugOptions.disasmOptions.followPC = lua["debugOptions"]["disasmOptions"]["FollowPC"].get_or( debugOptions.disasmOptions.followPC );
  debugOptions.disasmOptions.ShowLabelsInAddrCol = lua["debugOptions"]["disasmOptions"]["ShowLabelsInAddrCol"].get_or( debugOptions.disasmOptions.ShowLabelsInAddrCol );
  debugOptions.disasmOptions.tablePC = lua["debugOptions"]["disasmOptions"]["tablePC"].get_or( debugOptions.disasmOptions.tablePC );
