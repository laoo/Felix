...
//It's a relic of two instance of emulation in one process that was communicating using coarse algorithm through ComLynxWire.
//It needs to be rewritten to multiple processes
